    ...
    if(this.state.activePage === 0) {
      buttonDisplay = (
        <div>
          <ul class="pager">
            ...
            <li>
              <Link to={`/berries/page/${this.state.activePage + 1}`}  style={{ textDecoration: 'none' }}>Next</Link>
            </li>
          </ul>
        </div>
      );
      ...
      buttonDisplay = (
        <div>
          <ul class="pager">
              <li>
                <Link to={`/berries/page/${this.state.activePage - 1}`}  style={{ textDecoration: 'none' }}>Previous</Link>
              </li>
              <li class="disabled">
                <span>Next</span>
              </li>
